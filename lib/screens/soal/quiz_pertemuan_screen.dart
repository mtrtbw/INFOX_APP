// lib/screens/quiz_pertemuan_screen.dart
import 'dart:convert';
...
class _QuizPertemuanScreenState extends State<QuizPertemuanScreen>
  ...
  Future<void> _pilihPertemuan(Map<String, dynamic> pertemuan) async {
    ...
    if (isLocked) {
      String pesanPenolakan = 'Ujian ini sedang dikunci oleh guru.';
      if (statusAkses == 'TERJADWAL') {
        final jamBukaLengkap = _formatPesanWaktu(pertemuan['waktu_buka']);
        pesanPenolakan = 'Ujian ini baru bisa diakses pada $jamBukaLengkap.';
      }
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: RichText(
          text: TextSpan(
            ...
            children: [
              const TextSpan(text: 'Anda sudah mengerjakan ujian ini dengan nilai '),
              TextSpan(text: nilai, style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF3D5AFE))),
              const TextSpan(text: '.\n\nNilai Anda sudah masuk dan '),
              const TextSpan(text: 'belum dihapus oleh Admin', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red)),
              const TextSpan(text: '. Anda tidak diizinkan untuk mengulang ujian ini.'),
            ],
          ),
        ),
        ...
        child: ClipRRect(
          ...
          child: Row(children: [
            ...
            Container(
              width: 64, height: 80,
              decoration: BoxDecoration(
                  gradient: LinearGradient(colors: canAccess
                      ? [
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        // Badge Status Menggunakan Helper Format Waktu
                        if (isLocked)
                          Container(
                            padding: const EdgeInsets.symmetric(
                                horizontal: 8, vertical: 3),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 4),
                                  Text(statusAkses == 'TERJADWAL' ? _formatBadgeWaktu(p['waktu_buka']) : 'Terkunci',
                                      style: const TextStyle(
                                          fontSize: 11,
                                          fontWeight: FontWeight.w700,
                                          color: Colors.red)),
