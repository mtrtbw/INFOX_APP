          ...
          child: Column(
            ...
            children: [
              ...
              GridView.count(
                ...
                children: [
                  _fiturCard('📄', 'Materi', 'Baca modul pelajaran langsung di aplikasi', isTablet),
              ...
              const SizedBox(height: 10),
              _stepItem('2', '📚', 'Pilih Jenis Materi', 'Pilih antara file untuk membaca atau Video untuk menonton penjelasan.', isTablet),
              const SizedBox(height: 10),
              ...
              _faqItem('Apakah perlu internet?',
                  'Ya, koneksi internet diperlukan untuk memuat materi dan video pembelajaran.', isTablet),
              const SizedBox(height: 10),
              ...
              _faqItem('Materi apa saja yang tersedia?',
                  'Tersedia materi Informatika kelas VII sesuai Kurikulum Merdeka dalam format file dan video.', isTablet),
              const SizedBox(height: 10),
